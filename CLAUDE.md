...
The `.md` files in this repo (`docs/1-product-specification.md`, `docs/2-product-implementation-plan.md`, `README.md`, `CLAUDE.md`) and the codebase are meant to stay in sync with each other and with reality.
...
The implementation plan in `docs/2-product-implementation-plan.md` (see "Detailed substeps") defines the ordered list of steps to execute against this rule.
